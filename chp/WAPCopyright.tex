...
\node[text width=.5\textwidth,   fill=yellow!30,   fill opacity=0.6,  text opacity=0.8,   inner sep=10pt]  	%but this also makes photo transparent
    {	 \centering {\bf\Large Offer for Supply of Rail Wheelsets}\\
\vskip 0.4cm
\today \\
WWW.RITES.COM\\
CASE NO WA/Kenya/0001\\
};
\end{tikzpicture}
...
\colorbox{white}{
\textbf{\textcolor{red!60}{Cover Illustration: Map from http://www.un.org  \textbullet\ \texttt{http://www.rites.com}}}   }
\end{center}
...
\noindent \textit{May, 2016} % Printing/edition date
